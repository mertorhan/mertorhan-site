...
from .models import Author, Book, BookQuote, BookScore, Genre, Publisher


# Kunye listeleri: ucu de tek alanli, tek isleri isim tutmak.
...
class BookAdmin(ScoreAverageMixin, admin.ModelAdmin):
    ...
    # tasinmisti; burada bilerek ikisi birlikte durgan: veri elle
